...
python experiment_single_reward.py --env 'walker2d' --dataset 'medium' --seed 42  --save_iters '8,10,12' --eval_iters '8,9,10,11,12' --max_iters 12 --device 'cuda' --log_to_wandb True
